...
import { CTAButton } from '../assets/buttons/CTAButton.tsx';
    ...
    return (
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#40E0D0] via-[#2E86DE] to-[#A66CFF] flex items-center justify-center shadow-lg">
                                   <span className="text-white text-[16px] font-extrabold">{COLLEGE_SHORT_NAME}</span>

                                </div>
                                <div className="flex items-center gap-2">
                  <span className="bg-gradient-to-r from-[#40E0D0] via-[#2E86DE] to-[#A66CFF] bg-clip-text text-transparent" style={{ fontSize: '22px', fontWeight: '800' }}>
                    {WEBSITE_NAME}
                  </span>
                                    <span
                                        className="px-2 py-0.5 rounded bg-gradient-to-r from-[#40E0D0] via-[#2E86DE] to-[#A66CFF] text-white uppercase tracking-wider"
                    ...
                    Beta
                            ...
                            <div className="hidden md:flex items-center gap-3">
                                ...
                                {isAuthenticated ?
                                    <span className="inline-block px-3 py-1 rounded-xl bg-blue-50 text-blue-900 text-sm font-semibold border border-blue-200" dir="rtl">
        ...
        שלום, {user!.fullName.split(" ")[0]}
                                        ...
                                        <div className="grid grid-cols-2 gap-3 pt-4">
                                            <CTAButton variant="ghost" fullWidth>
                                                Sign in
                                            </CTAButton>
